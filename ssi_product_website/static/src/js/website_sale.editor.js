odoo.define('ssi_product_website.add_product', function (require) {
'use strict';
...
odoo.define('ssi_product_website.editor', function (require) {
'use strict';
...
options.registry.WebsiteSaleProductsItem = options.Class.extend({
    xmlDependencies: (options.Class.prototype.xmlDependencies || []).concat(['/ssi_product_website/static/src/xml/website_sale_utils.xml']),
    ...
    async _renderCustomXML(uiFragment) {
        ...
        Object.values(this.ribbons).forEach(ribbon => {
            const colorClasses = ribbon.html_class
                ...
                .join(' ');
            $select.append(qweb.render('ssi_product_website.ribbonSelectItem', {
                ribbon,
                colorClasses,
