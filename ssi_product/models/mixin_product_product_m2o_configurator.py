...
class MixinProductProductM2oConfigurator(models.AbstractModel):
    ...
    def _product_product_m2o_configurator_insert_form_element(self, view_arch):
        """Inject the product (variant) configurator widget into the form.
        ...
        :return: ``view_arch`` with the configurator template inserted
            at ``_product_product_m2o_configurator_form_xpath`` when
            ``_product_product_m2o_configurator_insert_form_element_ok``
